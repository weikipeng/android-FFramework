...
public class FFImageUtil {
	...
	public static Bitmap bitmapFromPath(final String path, int maxWidth,
		...
		if (tempBitmap != null
				&& maxHeight > 0
				&& maxWidth > 0
				&& (tempBitmap.getWidth() > maxWidth || tempBitmap.getHeight() > maxHeight)) {
			bitmap = Bitmap.createScaledBitmap(
					tempBitmap,
					getResizedDimension(maxWidth, maxHeight,
							tempBitmap.getWidth(), tempBitmap.getHeight()),
					getResizedDimension(maxHeight, maxWidth,
							tempBitmap.getHeight(), tempBitmap.getWidth()),
					true);
			tempBitmap.recycle();
		} else {
			bitmap = tempBitmap;
		...
		if (exif != null) {
			...
			switch (ori) {
				case ExifInterface.ORIENTATION_ROTATE_90 :
					return new int[]{bmpFactoryOptions.outHeight,
							bmpFactoryOptions.outWidth};
				case ExifInterface.ORIENTATION_ROTATE_180 :
					return new int[]{bmpFactoryOptions.outWidth,
