...
public abstract class FFBaseFragmentActivity extends FragmentActivity implements
		FFActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getContainer().setOnResizeListener(new OnResizeListener() {
			...
			public void OnInterceptTouchEvent(MotionEvent ev) {
				FFBaseFragmentActivity.this.OnInterceptTouchEvent(ev);
			}
		});
//		showToast(null, getTitle());
//		// 设置title文字
//		try {
